                ...
                <li class="item col-lg-3 col-md-4 col-sm-6 col-xs-6 ">
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        <div class="icon-sale-label sale-left">Sale</div>
                        <div class="pr-img-area"> <a title="${Abook.bookname}" href="${pageContext.request.contextPath}/Quick_viewServlet?param1=${Abook.bookname}">
                          <figure> <img class="first-img" src="${Abook.img1}" alt=""> <img class="hover-img" src="${Abook.img1}" alt=""></figure>
                          </a>
                         <button type="button" class="add-to-cart-mt" onclick="window.location.href='${pageContext.request.contextPath}/AddBookServlet?param1=${Abook.number}&param2=1'"> <i class="fa fa-shopping-cart"></i><span>添加到购物车</span> </button>
                        </div>              
                      </div>
                      <div class="item-info">
                        <div class="info-inner">
                          <div class="item-title"> <a title="${Abook.bookname}" href="${pageContext.request.contextPath}/Single_productServlet?param1=${Abook.bookname}">${Abook.bookname}</a> </div>
                          <div class="item-content">
                            <div class="item-price">
                              <div class="price-box"> <span class="regular-price"> <span class="price">¥${Abook.price}</span> </span> </div>
                              <div>销量：${Abook.sales}</div>
                              <div>上架时间：${Abook.date}</div>
                            </div>
                          </div>
                        </div>
                      </div>
