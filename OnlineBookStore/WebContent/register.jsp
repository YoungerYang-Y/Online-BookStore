                      ...
                      <div class="item-inner">
                        <div class="product-thumbnail">
                          ...
                          <div class="pr-img-area"> <a title="${Rbook.bookname}" href="${pageContext.request.contextPath}/Quick_viewServlet?param1=${Rbook.bookname}"  >
                            ...
                            <button type="button" class="add-to-cart-mt" onclick="window.location='#';"> <i class="fa fa-shopping-cart"></i><span>添加到购物车</span> </button>
                          </div>         
                        </div>
                        <div class="item-info">
        ...
        <div class="page-content">
            ...
            <div class="account-login">
             ...
             <form action="RegisterServlet" id="form" name="form" method="post" accept-charset="UTF-8">
                <label for="id">手机号<span class="required">*</span></label>
                <input id="id" type="text"  name="id" class="form-control">
                
                <label for="username">用户名<span class="required">*</span></label>
                <input id="username"  type="text" name="username" class="form-control">
                
                <label for="PIN">密码<span class="required">*</span></label>
