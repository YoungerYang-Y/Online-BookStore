              ...
              <div class="table-responsive">
                ...
                <table class="table table-bordered cart_summary">
                  ...
                  <tbody>                  	
                    ...
                    <tr>
                      <td class="cart_product"><a href="${pageContext.request.contextPath}/Single_productServlet?param1=${ListCart.bookname}"><img src="${ListCart.img1}" alt="Product"></a></td>
                      <td class="cart_description"><p class="product-name"><a href="${pageContext.request.contextPath}/Single_productServlet?param1=${ListCart.bookname}">${ListCart.bookname}</a></p></td>
