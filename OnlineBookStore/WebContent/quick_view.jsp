...
<div style="display: block;" id="quick_view_popup-wrap">
  <div id="quick_view_popup-outer">
        ...
        <div class="product-view-area">
          ...
          <div class="col-xs-12 col-sm-7 col-lg-7 col-md-7 product-details-area">
              <div class="product-name">
                <h1><a title="${Abook.bookname}" href="${pageContext.request.contextPath}/Single_productServlet?param1=${Abook.bookname}">${Abook.bookname}</a></h1>
              </div>
    ...
    </div><%-- <%=request.getContextPath() +"/FindBookServlet" %> --%>
